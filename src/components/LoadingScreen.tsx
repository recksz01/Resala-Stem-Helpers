                    ...
                    {["S", "T", "E", "M"].map((char, i) => (
                      <motion.div key={i} className="relative">
                        <motion.span
                          ...
                          className={`text-8xl md:text-[12rem] font-black italic tracking-tighter block leading-none select-none ${char === 'T' ? 'text-red-500 drop-shadow-[0_0_30px_rgba(239,68,68,0.3)]' : 'text-white'}`}
                        >
                          {char}
                        </motion.span>
